...
---
Minecraft requires the use of an ngrok TCP tunnel to share your server with others. Use the [ngrok agent](/agent/) to open a TCP tunnel on the default Minecraft port, `25565`.
