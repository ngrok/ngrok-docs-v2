...
---
import SSHHostCertificatesCreateRequest from '/snippets/api/resources/examples/_ssh_host_certificates_create_request.md';
import SSHHostCertificatesCreateResponse from '/snippets/api/resources/examples/_ssh_host_certificates_create_response.md';
import SSHHostCertificatesDeleteRequest from '/snippets/api/resources/examples/_ssh_host_certificates_delete_request.md';
import SSHHostCertificatesDeleteResponse from '/snippets/api/resources/examples/_ssh_host_certificates_delete_response.md';
import SSHHostCertificatesGetRequest from '/snippets/api/resources/examples/_ssh_host_certificates_get_request.md';
import SSHHostCertificatesGetResponse from '/snippets/api/resources/examples/_ssh_host_certificates_get_response.md';
import SSHHostCertificatesListRequest from '/snippets/api/resources/examples/_ssh_host_certificates_list_request.md';
import SSHHostCertificatesListResponse from '/snippets/api/resources/examples/_ssh_host_certificates_list_response.md';
import SSHHostCertificatesUpdateRequest from '/snippets/api/resources/examples/_ssh_host_certificates_update_request.md';
import SSHHostCertificatesUpdateResponse from '/snippets/api/resources/examples/_ssh_host_certificates_update_response.md';
