...
- Wait for [your limits to refresh](/pricing-limits#refreshing-limits).
...
ngrok's [free plans](/pricing-limits/) are generous, but some users on Free and Personal plans will find that they run into limits.
