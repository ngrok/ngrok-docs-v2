...
![alt-text](/guides/device-gateway/img/CNAME-device-gw.png)
...
![alt-text](/guides/site-to-site-connectivity/img/2tunnels.png)

5. Click **Check Status**, as denoted by the arrow in the screenshot below.

![alt-text](/guides/site-to-site-connectivity/img/check-status.png)

6. You should see a successful response similar to the screenshot below.

![alt-text](/guides/device-gateway/img/dns-success.png)
...
![alt-text](/guides/site-to-site-connectivity/img/authtoken.png)
