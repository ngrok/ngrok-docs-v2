...
import {ThemeImage} from "/snippets/components/ThemeImage/.jsx";
import MulticloudLight from "/public/img/multicloud-light.png";
import MulticloudDark from "/public/img/multicloud-api-gateway-architecture.png";
