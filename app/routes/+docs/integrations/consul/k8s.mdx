...
## **Step 1**: Set up a local Consul Service Mesh on Kubernetes
...
## **Step 4**: Configure Public Ingress for the sample application
...
## **Step 5**: Add OAuth Protection to the App
