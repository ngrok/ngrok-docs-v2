...
## **Step 1**: Create a new cluster with Rafay
...
## **Step 2**: Prepare your cluster for the ngrok Kubernetes Operator
...
## **Step 3**: Create and apply a blueprint for the ngrok Kubernetes Operator
...
## **Step 4**: Deploy an app with Rafay
