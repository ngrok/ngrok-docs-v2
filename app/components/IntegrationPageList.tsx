/**
 * Rework this component to just read whatever's in the directory and list that in the NgrokCard components, that way we don't need to have a bunch of state issues or any weirdness
 */
