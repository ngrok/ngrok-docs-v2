...
With Traffic Policy, you can connect your API to ngrok's [event logging system](/obs/) for smarter troubleshooting, testing, and integration of logging services like Datadog for your API gateway and upstream services.
