...
import { ConfigField, ConfigEnum } from "/snippets/ConfigTable.jsx";
...
<ConfigField title="mutual_tls_verification_strategy" type="string" required={false} defaultValue="require-and-verify">
  ...
  <ConfigEnum>
    <ConfigEnum.Option value="require-and-verify">Require and verify</ConfigEnum.Option>
    <ConfigEnum.Option value="require-any">Require any</ConfigEnum.Option>
    <ConfigEnum.Option value="request">Request</ConfigEnum.Option>
  </ConfigEnum>
</ConfigField>
