...
| --------- | ------------------- | --------------------- | ---------------------------------------------------- |
| Amazon    | `amazon`            | no                    | [Documentation](/integrations/amazon/oauth/)    |
| Facebook  | `facebook`          | no                    | [Documentation](/integrations/facebook/oauth/)  |
| GitHub    | `github`            | yes                   | [Documentation](/integrations/github/oauth/)    |
| GitLab    | `gitlab`            | yes                   | [Documentation](/integrations/gitlab/oauth/)    |
| Google    | `google`            | yes                   | [Documentation](/integrations/google/oauth/)    |
| LinkedIn  | `linkedin`          | yes                   | [Documentation](/integrations/linkedin/oauth/)  |
| Microsoft | `microsoft`         | yes                   | [Documentation](/integrations/microsoft/oauth/) |
| Twitch    | `twitch`            | yes                   | [Documentation](/integrations/twitch/oauth/)    |
