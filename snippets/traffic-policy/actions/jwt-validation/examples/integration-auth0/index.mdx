import ExampleTrafficPolicy from "/snippets/traffic-policy/actions/jwt-validation/examples/integration-auth0/example.mdx";
...
![Create your API in Auth0](/snippets/traffic-policy/actions/jwt-validation/examples/integration-auth0/img/jwt-create-new-api.png)
...
![Auth0 Test JWT](/snippets/traffic-policy/actions/jwt-validation/examples/integration-auth0/img/auth0-test.png)
...
![Auth0 API Permissions](/snippets/traffic-policy/actions/jwt-validation/examples/integration-auth0/img/jwt-machine-to-machine.png)
