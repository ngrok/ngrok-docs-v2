...
import RandomAgentConfigExample from "/snippets/examples/agent-config/tcp-random.mdx";
...
import FixedAgentConfigExample from "/snippets/examples/agent-config/tcp-fixed.mdx";
...
import NonLocalAgentConfigExample from "/snippets/examples/agent-config/tcp-nonlocal.mdx";
