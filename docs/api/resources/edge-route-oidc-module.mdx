import EdgeRouteOIDCModuleReplaceRequest from '/snippets/api/resources/examples/_edge_route_oidc_module_replace_request.md';
import EdgeRouteOIDCModuleReplaceResponse from '/snippets/api/resources/examples/_edge_route_oidc_module_replace_response.md';
import EdgeRouteOIDCModuleGetRequest from '/snippets/api/resources/examples/_edge_route_oidc_module_get_request.md';
import EdgeRouteOIDCModuleGetResponse from '/snippets/api/resources/examples/_edge_route_oidc_module_get_response.md';
import EdgeRouteOIDCModuleDeleteRequest from '/snippets/api/resources/examples/_edge_route_oidc_module_delete_request.md';
import EdgeRouteOIDCModuleDeleteResponse from '/snippets/api/resources/examples/_edge_route_oidc_module_delete_response.md';
