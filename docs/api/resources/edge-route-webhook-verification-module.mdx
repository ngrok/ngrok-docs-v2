import EdgeRouteWebhookVerificationModuleReplaceRequest from '/snippets/api/resources/examples/_edge_route_webhook_verification_module_replace_request.md';
import EdgeRouteWebhookVerificationModuleReplaceResponse from '/snippets/api/resources/examples/_edge_route_webhook_verification_module_replace_response.md';
import EdgeRouteWebhookVerificationModuleGetRequest from '/snippets/api/resources/examples/_edge_route_webhook_verification_module_get_request.md';
import EdgeRouteWebhookVerificationModuleGetResponse from '/snippets/api/resources/examples/_edge_route_webhook_verification_module_get_response.md';
import EdgeRouteWebhookVerificationModuleDeleteRequest from '/snippets/api/resources/examples/_edge_route_webhook_verification_module_delete_request.md';
import EdgeRouteWebhookVerificationModuleDeleteResponse from '/snippets/api/resources/examples/_edge_route_webhook_verification_module_delete_response.md';
