import EdgesHTTPSCreateRequest from '/snippets/api/resources/examples/_edges_https_create_request.md';
import EdgesHTTPSCreateResponse from '/snippets/api/resources/examples/_edges_https_create_response.md';
import EdgesHTTPSGetRequest from '/snippets/api/resources/examples/_edges_https_get_request.md';
import EdgesHTTPSGetResponse from '/snippets/api/resources/examples/_edges_https_get_response.md';
import EdgesHTTPSListRequest from '/snippets/api/resources/examples/_edges_https_list_request.md';
import EdgesHTTPSListResponse from '/snippets/api/resources/examples/_edges_https_list_response.md';
import EdgesHTTPSUpdateRequest from '/snippets/api/resources/examples/_edges_https_update_request.md';
import EdgesHTTPSUpdateResponse from '/snippets/api/resources/examples/_edges_https_update_response.md';
import EdgesHTTPSDeleteRequest from '/snippets/api/resources/examples/_edges_https_delete_request.md';
import EdgesHTTPSDeleteResponse from '/snippets/api/resources/examples/_edges_https_delete_response.md';
