import TunnelsListRequest from '/snippets/api/resources/examples/_tunnels_list_request.md';
import TunnelsListResponse from '/snippets/api/resources/examples/_tunnels_list_response.md';
import TunnelsGetRequest from '/snippets/api/resources/examples/_tunnels_get_request.md';
import TunnelsGetResponse from '/snippets/api/resources/examples/_tunnels_get_response.md';
