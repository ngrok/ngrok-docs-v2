import EdgesHTTPSRoutesCreateRequest from '/snippets/api/resources/examples/_edges_https_routes_create_request.md';
import EdgesHTTPSRoutesCreateResponse from '/snippets/api/resources/examples/_edges_https_routes_create_response.md';
import EdgesHTTPSRoutesGetRequest from '/snippets/api/resources/examples/_edges_https_routes_get_request.md';
import EdgesHTTPSRoutesGetResponse from '/snippets/api/resources/examples/_edges_https_routes_get_response.md';
import EdgesHTTPSRoutesUpdateRequest from '/snippets/api/resources/examples/_edges_https_routes_update_request.md';
import EdgesHTTPSRoutesUpdateResponse from '/snippets/api/resources/examples/_edges_https_routes_update_response.md';
import EdgesHTTPSRoutesDeleteRequest from '/snippets/api/resources/examples/_edges_https_routes_delete_request.md';
import EdgesHTTPSRoutesDeleteResponse from '/snippets/api/resources/examples/_edges_https_routes_delete_response.md';
