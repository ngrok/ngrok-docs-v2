import KubernetesOperatorsCreateRequest from '/snippets/api/resources/examples/_kubernetes_operators_create_request.md';
import KubernetesOperatorsCreateResponse from '/snippets/api/resources/examples/_kubernetes_operators_create_response.md';
import KubernetesOperatorsUpdateRequest from '/snippets/api/resources/examples/_kubernetes_operators_update_request.md';
import KubernetesOperatorsUpdateResponse from '/snippets/api/resources/examples/_kubernetes_operators_update_response.md';
import KubernetesOperatorsDeleteRequest from '/snippets/api/resources/examples/_kubernetes_operators_delete_request.md';
import KubernetesOperatorsDeleteResponse from '/snippets/api/resources/examples/_kubernetes_operators_delete_response.md';
import KubernetesOperatorsGetRequest from '/snippets/api/resources/examples/_kubernetes_operators_get_request.md';
import KubernetesOperatorsGetResponse from '/snippets/api/resources/examples/_kubernetes_operators_get_response.md';
import KubernetesOperatorsListRequest from '/snippets/api/resources/examples/_kubernetes_operators_list_request.md';
import KubernetesOperatorsListResponse from '/snippets/api/resources/examples/_kubernetes_operators_list_response.md';
import KubernetesOperatorsGetBoundEndpointsRequest from '/snippets/api/resources/examples/_kubernetes_operators_get_bound_endpoints_request.md';
import KubernetesOperatorsGetBoundEndpointsResponse from '/snippets/api/resources/examples/_kubernetes_operators_get_bound_endpoints_response.md';
