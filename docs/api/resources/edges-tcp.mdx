import EdgesTCPCreateRequest from '/snippets/api/resources/examples/_edges_tcp_create_request.md';
import EdgesTCPCreateResponse from '/snippets/api/resources/examples/_edges_tcp_create_response.md';
import EdgesTCPGetRequest from '/snippets/api/resources/examples/_edges_tcp_get_request.md';
import EdgesTCPGetResponse from '/snippets/api/resources/examples/_edges_tcp_get_response.md';
import EdgesTCPListRequest from '/snippets/api/resources/examples/_edges_tcp_list_request.md';
import EdgesTCPListResponse from '/snippets/api/resources/examples/_edges_tcp_list_response.md';
import EdgesTCPUpdateRequest from '/snippets/api/resources/examples/_edges_tcp_update_request.md';
import EdgesTCPUpdateResponse from '/snippets/api/resources/examples/_edges_tcp_update_response.md';
import EdgesTCPDeleteRequest from '/snippets/api/resources/examples/_edges_tcp_delete_request.md';
import EdgesTCPDeleteResponse from '/snippets/api/resources/examples/_edges_tcp_delete_response.md';
